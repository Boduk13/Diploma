...
public class DatabaseHelper extends SQLiteOpenHelper{
 ...
 ///DB
    private static String DB_NAME = "errors.db";
    private String table_name = "myerrors";
//Table
    public String ID = "_id";
    public String status_mes = "status_mes";
    public String description = "description";
    public String net_action = "net_action";
    public String on_site_action = "on_site_action";
  ...
  /**
    ...
    //Поиск запросом LIKE
    public Cursor fetchRecordsByQuery(Editable query) {
