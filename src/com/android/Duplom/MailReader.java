...

{
    ...
    public MailReader() {
...

        {
            ...
            store.connect("pop.gmail.com", 995, "hbodya13@gmail.com",
                    "BodikTurbo30043991");
            ...
            System.out.println("No. Messages : " + messages.length);
...

    {
        ...
        if ((a = message.getRecipients(Message.RecipientType.TO)) != null) {
            for (int j = 0; j < a.length; j++) {
              //  System.out.println("TO: " + Arrays.toString(a[j]));
            }
        }
